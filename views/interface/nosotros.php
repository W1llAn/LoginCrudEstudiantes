    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'https://crudestudiantes-hmf5d8dxcph7eacy.westus-01.azurewebsites.net/controllers/APIRest.php?tipo=cursos', // Cambia esto por la ruta correcta a tu archivo PHP para obtener los cursos
                method: 'GET',
                dataType: 'json',
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $('#student-form').off('submit').on('submit', function(e) {
            ...
            $.ajax({
                url: 'https://crudestudiantes-hmf5d8dxcph7eacy.westus-01.azurewebsites.net/controllers/APIRest.php?cedula='+cedula, 
                method: 'PUT',
                data: formData, 
                dataType: 'json',
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        if (confirm("¿Estás seguro de que quieres eliminar este estudiante?")) {
            ...
            $.ajax({
                url: 'https://crudestudiantes-hmf5d8dxcph7eacy.westus-01.azurewebsites.net/controllers/APIRest.php?cedula='+cedula, // Ruta al archivo PHP de eliminación
                method: 'DELETE',
                dataType: 'json',
                success: function(response) {
                    alert(response);
