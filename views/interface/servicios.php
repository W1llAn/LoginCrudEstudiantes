    ...
    <script type="text/javascript">
        ...
        function editUser(){
            ...
            if (row){
                ...
                $('#fm').form('load', row);
                loadCurID(row.curId);
                url = 'http://crudestudiantes-hmf5d8dxcph7eacy.westus-01.azurewebsites.net/controllers/APIRest.php?cedula='+row.estCedula;
            }
        }
        ...
        function loadCurID(selectedCurID = null) {
            $('#curId').combobox({
                url: 'http://crudestudiantes-hmf5d8dxcph7eacy.westus-01.azurewebsites.net/controllers/APIRest.php?tipo=cursos',
                method:'GET',
                valueField: 'curId',
                textField: 'nombre',
                panelHeight: 'auto',
        ...
        function saveUser(){
            try {
                if (url != 'http://crudestudiantes-hmf5d8dxcph7eacy.westus-01.azurewebsites.net/controllers/APIRest.php') {
                //Enviar los datos del formulario para editar el estudiante
                $.ajax({
                    url:  'http://crudestudiantes-hmf5d8dxcph7eacy.westus-01.azurewebsites.net/controllers/APIRest.php?cedula='+$('#fm').find('input[name="estCedula"]').val()  , // URL con la cedula
                    type: 'PUT', 
                    data: {
